    ...
    <>
        <Button variant="primary" onClick={handleShow}>
                ...
                >
                    ...
                    <Modal.Body>
                        <form id="updatePrice" className="w-full max-w-sm">
    ...
    return(
        ...
        <Button variant="primary" onClick={handleShow}>
                ...
                >
                    ...
                    <Modal.Body>
                        <form id="addSeasonal" className="w-full max-w-sm">
                            <div className="md:flex md:items-center mb-6">
                                <div className="md:w-1/3">
                                    <label className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="name">
                                        Seasonal Menu Item
                                ...
                                <div className="md:w-2/3">
                                    <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="seasonalItemName" type="text" defaultValue="" placeholder="Item Name"/>
                                </div>
                            </div>
                            <div className="md:flex md:items-center mb-6">
                                <div className="md:w-1/3">
                                ...
                                <div className="md:w-2/3">
                                    <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="seasonalItemPrice" type="text" defaultValue="" placeholder="0.00"/>
                                </div>
                            </div>
                        </form>
                    </Modal.Body>
